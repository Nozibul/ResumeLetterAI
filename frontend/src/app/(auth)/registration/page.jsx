...
import { registerUser } from '@/shared/store/actions/authActions';
...
export default function RegistrationPage() {
  ...
  // Check valid navigation on mount
  useEffect(() => {
    ...
    // Clear token after use so refresh won't restore access
    sessionStorage.removeItem('nav_from_login');
    sessionStorage.removeItem('nav_timestamp');
  }, [router]);
        ...
        toast.success(
          <div className="space-y-2">
            ...
            <div className="text-sm text-gray-600">
              ...
              <strong className="text-teal-600">{formData.email}</strong>
            </div>
            <div className="flex items-start gap-2 bg-amber-50 border border-amber-200 rounded-lg p-2 mt-2">
              <Clock className="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" />
              <div className="text-xs text-amber-800">
                <strong>Important:</strong> Verify within{' '}
                <strong>30 minutes</strong> or your account will be deleted
              </div>
            </div>
          </div>,
          {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-30 -left-40 w-90 h-90 bg-teal-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-4">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-500">
              Join us and start building amazing resumes
            </p>
          </div>
