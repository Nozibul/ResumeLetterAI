...
export default function ForgotPasswordPage() {
  ...
  const handleForgotPassword = async (email) => {
    try {
      ...
      } else if (statusCode === 404 || !statusCode) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-purple-50 flex items-center justify-center p-4">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-teal-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-gray-500">
                The link will expire in <strong>10 minutes</strong>. Don't
